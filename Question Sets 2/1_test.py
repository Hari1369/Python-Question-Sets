...
# 11) Count Even Number: input: number = [12,15,8,21,30,17,4] output: 4
number = [12,15,8,21,30,17,4]
n = len(number)
count_even = 0
for i in range(n):
    if number[i] % 2 == 0:
...
# 12) Sum of Odd Number: number = [10,3,7,8,15,20,11] output : 36
number = [10,3,7,8,15,20,11]
n = len(number)
sum_odd = 0
for i in range(n):
    if number[i] % 2 != 0:
...
# 13) Find largest Numbers: numbers = [15, 7, 28, 4, 19, 32, 10] output = 32
number = [15, 7, 28, 4, 19, 32, 10]
n = len(number)
...
# 14) Count Vowels word = "programming" output = 3
word = "programming"
vowels = "aeiou"
count = 0
n1 = len(word)
...
# 14) Create a new string containing only the vowels word = "developer" output = eeoe
word = "developer"
vowels = "aeiou"
n1 = len(word)
n2 = len(vowels)
...
# 15) words = ["apple", "sky", "orange", "tree"] output = aeeoee
words = ["apple", "sky", "orange", "tree"]
n1 = len(words)
vowels = "aeiou"
result = ""
n2 = len(vowels)
...
# 16) Find the Word With Most Vowels words = ["apple", "sky", "education", "banana", "queue"] output : education
words = ["apple", "sky", "education", "banana", "queue"]
n1 = len(words)
vowels = "aeiou"
n2 = len(vowels)
